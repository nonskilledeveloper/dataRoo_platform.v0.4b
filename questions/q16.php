...
<img id="img-q" class = "img-question" src="img/q16.png" alt="q16">
<div id = "overlay"></div>

<br>
<form id = "overlay-form" class = "score-quest" action="verify-answer.php" method="POST">
<label><h2>Question:</h2></label><br>
<label style="color: grey;">How should the result in the image be rated for the query: Ram 1500 2022?</label>
<br><br>
...
<br><br>
<?php
echo '<input type="hidden" name="query" value="q16">';
